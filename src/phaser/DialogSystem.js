...
export default class DialogSystem {
  ...
  createDialogUI() {
    ...
    console.log(
      `Dialog box dimensions: ${boxWidth}x${boxHeight} at ${margin},${boxY}`
    );
  ...
  createTextInput() {
    ...
    const dialogBottom = this.dialogBoxInfo.boxY + this.dialogBoxInfo.boxHeight;
    const inputBottom = Math.max(
      availableHeight * 0.2,
      availableHeight - dialogBottom - 120
    );
